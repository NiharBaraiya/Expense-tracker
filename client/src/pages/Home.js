    ...
    <div className="home-container">
      ...
      <section className="how-it-works">
        ...
        <ol className="steps-list">
          <li><strong></strong> 1️⃣ Create an account and log in securely.</li>
          <li><strong></strong>2️⃣ Add income and expense entries as they happen.</li>
          <li><strong></strong>3️⃣Categorize your transactions for clarity.</li>
          <li><strong></strong>4️⃣View charts, insights, and manage your budget!</li>
        </ol>
      </section>
      ...
      <section className="cta-section">
        ...
        <p>Join thousands of users already managing their budgets with Expense Tracker.</p>
